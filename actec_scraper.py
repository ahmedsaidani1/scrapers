"""
Actec Solar Scraper
Website: https://www.actec-solar.de
"""
import sys
import re
...
class ActecScraper(BaseScraper):
    """
    Scraper for Actec Solar equipment website.
    """
    ...
    def __init__(self):
        ...
        self.base_url = self.config.get("base_url", "https://www.actec-solar.de")
    ...
    def get_product_urls(self) -> List[str]:
        ...
        if response:
            ...
            for loc in locs:
                url = loc.text.strip()
                # Filter for product pages (Actec uses specific patterns)
    ...
    def _scrape_category_pages(self) -> List[str]:
        ...
        # Common category URLs for Actec Solar
        category_urls = [
            f"{self.base_url}/komplettanlagen",
        ...
        for category_url in category_urls:
            ...
            if response:
                ...
                for link in all_links:
                    ...
                    if any(keyword in href.lower() for keyword in ['komplettanlage', 'balkonkraftwerk', 'solarmodul', 'wechselrichter', 'batteriespeicher']):
                        # Make absolute URL
                        if href.startswith('/'):
