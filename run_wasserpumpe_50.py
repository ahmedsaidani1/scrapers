"""
Run Wasserpumpe scraper with 50 products limit (Cloudscraper-based)
"""
import sys
import time
...
def run_limited_scrape(limit=50):
    ...
    print("="*70)
    print(f"WASSERPUMPE SCRAPER (CLOUDSCRAPER) - LIMITED TO {limit} PRODUCTS")
    print("="*70)
    ...
    if success_count > 0:
        ...
        sheet_id = SHEET_IDS.get("wasserpumpe")
