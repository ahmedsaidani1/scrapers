...
SCRAPER_NAME = "sanundo"


class SanundoScraper(BaseScraper):
    """
    Scraper for Sanundo (Shopware platform - bathroom & sanitary products).
    ...
    def __init__(self):
        ...
        self.base_url = self.config.get("base_url", "https://sanundo.de")
    ...
    def get_product_urls(self) -> List[str]:
        ...
        Sanundo uses gzipped sitemap files.
        """
        product_urls = []
