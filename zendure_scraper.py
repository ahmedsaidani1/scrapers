"""
Zendure Scraper
Website: https://eu.zendure.com (Shopify store)
"""
import sys
import re
...
SCRAPER_NAME = "zendure"


class ZendureScraper(BaseScraper):
    """
    Scraper for Zendure solar equipment website (Shopify store).
    """
    ...
    def __init__(self):
        ...
        self.base_url = self.config.get("base_url", "https://eu.zendure.com")
    ...
    def _scrape_category_pages(self) -> List[str]:
        ...
        # Common category URLs for Zendure (Shopify collections)
        category_urls = [
            f"{self.base_url}/collections/all",
            f"{self.base_url}/collections/portable-power-stations",
            f"{self.base_url}/collections/solar-panels",
        ]
